...
Only the most recent version of Chatter is supported with security updates. Each new release deprecates all older
versions.

## Reporting a Vulnerability

If you discover a vulnerability, please report it using the
[Security section](https://github.com/Foulest/Chatter/security) in the GitHub repository.
...
- The version of Chatter you are using.
...
Thank you for helping to keep Chatter and its users safe!
